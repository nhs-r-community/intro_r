...
Slides and code are available on [`r icons::fontawesome("github")`   original](https://github.com/nhs-r-community/intro_r)  
and [`r icons::fontawesome("github")`   updated](https://github.com/Lextuga007/intro_r/tree/feature_conversion))  
