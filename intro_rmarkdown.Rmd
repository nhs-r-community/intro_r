...
Typically, the first code chunk would be a "setup" chunk (this name is important). This may include global settings (explained later) and perhaps a list of libraries used:
