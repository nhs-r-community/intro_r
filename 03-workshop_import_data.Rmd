...
</br> We’d like to import the .blue[capacity_ae.csv] file. </br> 
...
</br>  Put the cursor in the line you want to run then select the button to Run or .blue[Ctrl + Return]
